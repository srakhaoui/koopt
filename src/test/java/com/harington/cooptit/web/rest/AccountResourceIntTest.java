...
import com.harington.cooptit.config.Constants;
import com.harington.cooptit.domain.Authority;
import com.harington.cooptit.domain.User;
import com.harington.cooptit.repository.AuthorityRepository;
...
import com.harington.cooptit.service.dto.PasswordChangeDTO;
import com.harington.cooptit.service.dto.UserDTO;
import com.harington.cooptit.web.rest.errors.ExceptionTranslator;
import com.harington.cooptit.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResourceIntTest {
    ...
    public void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.COOPTER));
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.COOPTER));
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.COOPTER));
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities()).hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.COOPTER).get());
    }
